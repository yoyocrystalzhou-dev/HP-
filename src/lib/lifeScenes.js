...
export const LIFE_SCENE_RULES =
  "【生活场景规则（自由度优先）】\n" +
  "1. 玩家输入地点与扮演行为，只代表 TA 想去哪里、正在怎么行动；绝不代表固定收益、固定剧情或固定数值变化。\n" +
  "2. 例如“去图书馆”不是自动读书成功或学术增加。你应依据当前时间、原著节点、在场角色、好感度、近期记忆，自由生成可能发生的生活片段：安静阅读、偶遇、误会、线索、被警告、什么也没发生等都可以。\n" +
  "3. 玩家通常不会说幕后提示词。请从扮演行为里理解软方向：闲逛/坐下偏日常，寻找/靠近某人偏互动，偷听/翻找/观察异常偏线索，夜游/禁区/躲避巡逻偏风险；不要要求玩家选择额外系统，不要把它机械化。\n" +
